...
Prodotto p4 = new Prodotto("Vetril", "Prodotto per pulire i vetri", 4);
...
Console.WriteLine("Prezzo senza iva: " + p1.getPrezzo());
...
Console.WriteLine("Prezzo senza iva: " + p2.getPrezzo());
...
Console.WriteLine("Prezzo senza iva: " + p3.getPrezzo());
...
Console.WriteLine("Prezzo senza iva: " + p4.getPrezzo());